...
class SignUpBloc extends Bloc<SignUpEvent, SignUpState> {
  ...
  Stream<SignUpState> mapEventtoState(SignUpEvent event) async* {
    ...
    if(event is ClickSignUpEvent) {
      ...
      yield SignUpState(result, SignUpStateValue.IN_PROGRESS);
      try {
      ...
      yield SignUpState(result, SignUpStateValue.DONE, registrationComplete: complete);
    } else {
      yield const SignUpState({}, SignUpStateValue.DONE);
    }
  }
}